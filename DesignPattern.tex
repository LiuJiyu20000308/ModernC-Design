...
\input{1.Policy/Policy}

\input{2&3.Techniques/Techniques}

\input{2&3.Techniques/TypeLists}

\input{4.SmallObj/SmallObj}

\input{5.Functor/Functor}

\input{6.Singleton/Singleton}

\input{7.SmartPointer/SmartPointer}

\section{Factory}
\includepdf[pages=-]{8.Factory/factory.pdf}
\end{document}
%%% Local Variables:
%%% mode: xelatex
%%% TeX-master: t
